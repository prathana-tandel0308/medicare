...
const MONGODB_URI =
  'mongodb+srv://medicoreadmin:Medicare12345@cluster0.1awx66l.mongodb.net/hospital_ms?appName=Cluster0';
  ...
  try {
    ...
    const patients = [
      ...
      },
      {
        ...
        admittedDate: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000),
      },
      {
        patientId: 'PAT00005',
        name: 'Suresh Verma',
